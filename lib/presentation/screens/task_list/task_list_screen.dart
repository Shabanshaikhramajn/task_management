            ...
            Expanded(
              child: BlocBuilder<TaskBloc, TaskState>(
                builder: (context, state) {
                  ...
                  if (state is TaskEmpty) return const Center(child: Text('No tasks found'));
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<FilterOption>(
      onSelected: (filter) {
        TaskStatus? status;
        switch (filter) {
          case FilterOption.all: status = null; break;
          case FilterOption.pending: status = TaskStatus.pending; break;
          case FilterOption.inProgress: status = TaskStatus.inProgress; break;
          case FilterOption.completed: status = TaskStatus.completed; break;
        }
      ...
      itemBuilder: (_) => const [
        ...
        PopupMenuItem(value: FilterOption.inProgress, child: Text('In Progress')),
